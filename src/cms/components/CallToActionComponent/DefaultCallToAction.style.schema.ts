...
import { CallToActionComponentDefinition } from './CallToAction.type.schema.js';

// Auto-registering Call To Action (Button List) Default style schema
export const DefaultCallToActionStyleDefinition = StyleSchema({
  key: 'DefaultCallToAction',
  displayName: 'Call To Action (Button List) Default',
