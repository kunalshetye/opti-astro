  ...
  settings: {
      ...
      delay: {
        ...
        choices: {
          ...
          short: {
            displayName: 'Short (0.5s)',
            sortOrder: 20,
          },
          medium: {
            displayName: 'Medium (1s)',
            sortOrder: 30,
          },
          long: {
            displayName: 'Long (1.5s)',
            sortOrder: 40,
          },
          verylong: {
            displayName: 'Very Long (2s)',
            sortOrder: 50,
          },
        },
      },
